...
REGISTER_I2C_PCI_DETECTOR("PowerColor Red Devil RX6700XT",          DetectPowerColorRedDevilGPUControllersV1, AMD_GPU_VEN, AMD_NAVI22_DEV,  POWERCOLOR_SUB_VEN, POWERCOLOR_RED_DEVIL_RX6700XT_SUB_DEV,              0x22);
